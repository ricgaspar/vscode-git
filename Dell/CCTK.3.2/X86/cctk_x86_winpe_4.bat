...
REM	Example: cctk_x86_WinPE_4.bat C:\vistape_x86 C:\Progra~1\Dell\Comman~1\
...
set WinPERoot=C:\Program Files\Windows Kits\8.0\Assessment and Deployment Kit\Windows Preinstallation Environment
set OSCDImgRoot=C:\Program Files\Windows Kits\8.0\Assessment and Deployment Kit\Deployment Tools\x86\Oscdimg

set ADKTOOLSROOT=C:\Program Files\Windows Kits\8.0\Assessment and Deployment Kit
...
"%OSCDImgRoot%\oscdimg.exe" -b%WINPEPATH%\fwfiles\etfsboot.com -n %WINPEPATH%\ISO %WINPEPATH%\WIM\Command_Configure_x86_4.iso
...
:usage
echo.
echo cctk_x86_winpe_4.bat
echo.
echo Copyright 2009 - 2017 Dell Inc. All rights reserved.
echo.
echo Usage : cctk_x86_winpe_4.bat WINPEPATH CCTKPATH
echo.
echo Where:
...
echo ***********************************************************************
echo.
echo Example: cctk_x86_WinPE_4.bat C:\winsevpe_x86 C:\Progra~1\Dell\Comman~1\
...
:done
@echo -------------------------------
@echo (cctk_x86_winpe_4.bat)-DONE
@echo -------------------------------
set WINPEPATH=
set CCTKPATH=
set AIKTOOLS=
