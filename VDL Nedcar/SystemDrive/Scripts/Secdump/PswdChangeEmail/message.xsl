  ...
  <body>
		<div class="container">
			<div id="content">
				...
				<p>Be aware that your new password must adhere to the rules below.
					<ul style='line-height: 0.2em'>
						...
						<li style='line-height: 1.2em'>Your new password must be at least 4 characters in length.</li>
						<li style='line-height: 1.2em'>Your new password must not be similar to your username.</li>
					</ul>
				</p>				
				<p>
